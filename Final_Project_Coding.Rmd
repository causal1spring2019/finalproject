...
final_data$AgeIn1997 <- as.numeric((dmy("30 06 1997") - final_data$Birthdate)/365.25) #This is approximate
 ...
 final_data$bmiz <-  AGD::y2z(y = final_data$BMI, x = final_data$AgeIn1997, sex = final_data$KEY_SEX_1997, ref = cdc.bmi)
...
#just race and gender with exposure/outcome
...
#just sexual orientaion, learning disability and born in US with exp/out
table(final_data$bullied_bf_12_1997,final_data$ever_new_user2,
      final_data$anySameSex, final_data$learning_disability_1997, final_data$CV_CITIZENSHIP_1997,
      useNA="ifany")
...
table(final_data$bullied_bf_12_1997,final_data$ever_new_user2,
      final_data$KEY_RACE_ETHNICITY_1997,  final_data$KEY_SEX_1997,
      final_data$MomEduDi, final_data$overweight,
      final_data$YOUTH_BOTHBIO.01_1997,
      useNA="ifany")
...
BMIbybullyingstatus <- group_by(final_data, bullied_bf_12_1997) %>% 
                        ggplot(aes(BMI, fill = bullied_bf_12_1997)) +
...
#Boxplots for BMI
BMIbybullyingstatusBox <- group_by(final_data, bullied_bf_12_1997) %>% 
                        ggplot(aes(y=BMI, fill = bullied_bf_12_1997)) +
                          geom_boxplot() 
