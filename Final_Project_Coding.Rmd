...
final_data$AgeIn1997 <- as.numeric((dmy("30 06 1997") - final_data$Birthdate)/365.25) #This is approximate, both because birthdates only had month/year and because I just calculated from the middle of the year 1997
 ...
 #Note, there's one observation with a z score of -20, and some with -Inf? trying to find those
...
#just sexual orientation with exp/out
