...
BootstrappedEsts2 <- foreach (b=1:B, .combine=rbind, .packages='SuperLearner') %dopar% { 
  #this is just a paralellized  version of a for loop
...
BootstrappedEsts3 <- foreach (b=1:B, .combine=rbind, .packages='SuperLearner') %dopar% { 
  #this is just a paralellized  version of a for loop
...
BootstrappedEsts4 <- foreach (b=1:B, .combine=rbind, .packages='SuperLearner') %dopar% { 
  #this is just a paralellized  version of a for loop
...
BootstrappedEsts5 <- foreach (b=1:B, .combine=rbind, .packages='SuperLearner') %dopar% { 
  #this is just a paralellized  version of a for loop
...
BootstrappedEsts6 <- foreach (b=1:B, .combine=rbind, .packages='SuperLearner') %dopar% { 
  #this is just a paralellized  version of a for loop
...
BootstrappedEsts7 <- foreach (b=1:B, .combine=rbind, .packages='SuperLearner') %dopar% { 
  #this is just a paralellized  version of a for loop
...
BootstrappedEsts8 <- foreach (b=1:B, .combine=rbind, .packages='SuperLearner') %dopar% { 
  #this is just a paralellized  version of a for loop
...
BootstrappedEsts9 <- foreach (b=1:B, .combine=rbind, .packages='SuperLearner') %dopar% { 
  #this is just a paralellized  version of a for loop
...
BootstrappedEsts10 <- foreach (b=1:B, .combine=rbind, .packages='SuperLearner') %dopar% { 
  #this is just a paralellized  version of a for loop
...
#combine the matrices from the ten sections into one matrix
BootstrappedEsts <- rbind(BootstrappedEsts1, 
                          BootstrappedEsts2,
                          BootstrappedEsts3,
                          BootstrappedEsts4,
                          BootstrappedEsts5,
...
#turn the matrix that was put out by the bootstrapping function into a dataframe with the estimate from each iteration of the bootstrap
BootstrappedEsts <-as.data.frame(BootstrappedEsts)
BootstrappedEsts <- BootstrappedEsts %>% dplyr::rename(gCompBoot = V1, IPTWboot = V2)
