...
|||
$\textbf{BMI percentile}$ | `r round(mean(final_data$bmiz),2)` (*mean*) |  `r round(sd(final_data$bmiz),1)` (*sd*) |
...
```{r, include = TRUE, echo = FALSE, fig.width=14, fig.height = 6, cache = FALSE}
...
```{r, include = TRUE, echo = FALSE, fig.width= 16, fig.height = 10, cache = FALSE}
...
```{r, include = TRUE, echo = FALSE, warning = FALSE, fig.width= 16, fig.height = 10, cache = FALSE}
BootstrappedHist
```
