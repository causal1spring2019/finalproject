...
# create dataset of A & Ws
X<- subset(final_data, select=c("KEY_RACE_ETHNICITY_1997", "KEY_SEX_1997","BMI", "MomEduDi", "YOUTH_BOTHBIO.01_1997", "bullied_bf_12_1997"))
# create a vector of Y
Y = as.numeric(final_data$ever_new_user2)
Y = ifelse(Y==1, 0, 1)

#run SL
SL.out = SuperLearner(Y=Y, X=X, SL.library=SL.library, family='binomial', cvControl=list(V=4))
