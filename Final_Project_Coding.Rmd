...
--------- | ---------- | --------- |
$\textbf{Drug use (Total)}$ | `r druguse[2]` (`r druguse[2]/N`\%) | `r druguse[1]` (`r druguse[1]/N`\%) |
...
```{r DAG 3, echo=FALSE, out.width = '100%'}
...
```{r DAG 4, echo=FALSE, out.width = '100%'}
...
```{r DAG 5, echo=FALSE, out.width = '100%'}
...
```{r DAG 6, echo=FALSE, out.width = '100%'}
