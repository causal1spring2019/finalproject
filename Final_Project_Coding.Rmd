...
--------- | ---------- | --------- | ---------- | ---------
glm | `r round(ltmle.SL$fit$g[[2]]$bullied[1,1],4)` | `r ltmle.SL$fit$g[[2]]$bullied[1,2]` | `r round(ltmle.SL$fit$Q[[2]]$Y[1.1],4)` | `r round(ltmle.SL$fit$Q[[2]]$Y[1,2],4)`
glm.interaction | `r round(ltmle.SL$fit$g[[2]]$bullied[2,1],4)` | `r round(ltmle.SL$fit$g[[2]]$bullied[2,2],4)` | `r round(ltmle.SL$fit$Q[[2]]$Y[2,1],4)` | `r ltmle.SL$fit$Q[[2]]$Y[2,2]`
glmnet | `r round(ltmle.SL$fit$g[[2]]$bullied[3,1],4)` | `r ltmle.SL$fit$g[[2]]$bullied[3,2]` | `r round(ltmle.SL$fit$Q[[2]]$Y[3,1],4)` | `r ltmle.SL$fit$Q[[2]]$Y[3,2]`
bayesglm | `r round(ltmle.SL$fit$g[[2]]$bullied[4,1],4)` | `r ltmle.SL$fit$g[[2]]$bullied[4,2]` | `r round(ltmle.SL$fit$Q[[2]]$Y[4,1],4)` | `r ltmle.SL$fit$Q[[2]]$Y[4,2]`
randomForest | `r round(ltmle.SL$fit$g[[2]]$bullied[5,1],4)` | `r round(ltmle.SL$fit$g[[2]]$bullied[5,2],4)` | `r round(ltmle.SL$fit$Q[[2]]$Y[5,1],4)` | `r round(ltmle.SL$fit$Q[[2]]$Y[5,2],4)`
step | `r round(ltmle.SL$fit$g[[2]]$bullied[6,1],4)` | `r round(ltmle.SL$fit$g[[2]]$bullied[6,2],4)` | `r round(ltmle.SL$fit$Q[[2]]$Y[6,1],4)` | `r round(ltmle.SL$fit$Q[[2]]$Y[6,2],4)`
mean | `r round(ltmle.SL$fit$g[[2]]$bullied[7,1],4)` | `r round(ltmle.SL$fit$g[[2]]$bullied[7,2],4)` | `r round(ltmle.SL$fit$Q[[2]]$Y[7,1],4)` | `r round(ltmle.SL$fit$Q[[2]]$Y[7,2],4)`
...
--------- | ---------- | --------- 
SuperLearner | `r round(CVtable$Ave[1],4)` | `r round(CVtable$se[1],4)`
Discrete SL | `r round(CVtable$Ave[2],4)` | `r round(CVtable$se[2],4)`
glm | `r round(CVtable$Ave[3],4)` | `r round(CVtable$se[3],4)`
glm.interaction | `r round(CVtable$Ave[4],4)` | `r round(CVtable$se[4],4)`
glmnet | `r round(CVtable$Ave[5],4)` | `r round(CVtable$se[5],4)`
bayesglm | `r round(CVtable$Ave[6],4)` | `r round(CVtable$se[6],4)`
randomForest | `r round(CVtable$Ave[7],4)` | `r round(CVtable$se[7],4)`
step | `r round(CVtable$Ave[8],4)` | `r round(CVtable$se[8],4)`
mean | `r round(CVtable$Ave[9],4)` | `r round(CVtable$se[9],4)`
