...
Ws: Race/ethnicity, age (NOTE: I THINK THIS IS LEFTOVER AND SHOULD BE TAKEN OUT), sex, BMI, not living with both biological parents, mother's educational status (all Ws were measured at baseline) 
