...
Simple Substitution: 
$\hat\Psi(P_n) = \sum_{W}[E_0(Y|A=1,W=w)-E_0(Y|A=0,W=w)]P_0(W=w)$

IPTW with stabilized weights:
$\hat\Psi(P_n) = \frac{1/n\sum_{i=1}^{n}\frac{I(A_i=1)}{g(A_i|W_i)}Y_i}{1/n\sum_{i=1}^{n}\frac{I(A_i=1)}{g(A_i|W_i)}}-\frac{1/n\sum_{i=1}^{n}\frac{I(A_i=0)}{g(A_i|W_i)}Y_i}{1/n\sum_{i=1}^{n}\frac{I(A_i=0)}{g(A_i|W_i)}}$
