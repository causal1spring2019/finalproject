...
And finally, this was not a random sample (our link was simplified for this project, as described in step 4, above) and in subsequent analyses we would plan to use the sample weights such that these analyses would be reflective of the US population, as intended when the study was designed.
